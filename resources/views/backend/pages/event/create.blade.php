                  ...
                  <!-- form start -->
                    ...
                    <div class="card-body">
                        {{-- <form action="{{ route('sliders.store') }}" method="post" enctype="multipart/form-data"> --}}
                            <form action="{{ route('events.store') }}" method="post" enctype="multipart/form-data" id="image-upload" class="dropzone">
                            @csrf
                        <div class="row">
                                <div class="col">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="title" id="name" required  value="{{ old('title') }}" placeholder="Enter Title">
                                        @if($errors->has('title'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" name="image" id="exampleInputFile" required onchange="readURL(this);">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="amount" id="amount" required  value="{{ old('amount') }}" placeholder="Enter Amount">
