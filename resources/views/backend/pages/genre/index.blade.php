          ...
          <div class="col-4">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Genres Create</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          <button type="button" class="badge badge-primary" data-toggle="modal" data-target="#assignProduct{{ $Genre->id }}">
                            <i class="fa fa-edit"></i>
                         </button>
                         
                         <!-- Modal -->
                          <div class="modal fade" id="assignProduct{{ $Genre->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                             ...
                             <div class="modal-content">
                                 ...
                                 <div class="modal-body">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" value="{{ $Genre->name }}" placeholder="Enter Name" required>
                                      </div>
                                 </div>
